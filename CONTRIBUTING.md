...
# Contributing to the ArcGIS Portal Viewer sample application

This guide describes how you can contribute improvements to the ArcGIS Portal Viewer sample application source code.
...
3. [Fork](https://help.github.com/articles/fork-a-repo) the [ArcGIS Portal Viewer sample application repo](https://github.com/Esri/arcgis-portalviewer-dotnet) on GitHub.
4. Clone it to your local machine.
5. Checkout the [master branch](https://github.com/Esri/arcgis-portalviewer-dotnet/tree/master).
